...
//        tj.itens[5].worldY = 20 * tj.tileSize;
    ...
    public void setEsqueleto(){
        tj.esqueleto[0] = new Esqueleto("esqueleto",5,2,3,2,3,tj, null);
        tj.esqueleto[0].worldX = tj.tileSize* 15;
        tj.esqueleto[0].worldY = tj.tileSize*36;

        tj.esqueleto[1] = new Esqueleto("esqueleto",100,50,3,2,3,tj,null);
        tj.esqueleto[1].worldX = tj.tileSize* 23;
        tj.esqueleto[1].worldY = tj.tileSize*34;
